...
var Swamiji = /** @class */ (function () {
    function Swamiji(firstname, lastname, age) {
        this.firstname = firstname;
        this.lastname = lastname;
        this.age = age;
    }
    Swamiji.prototype.getFirstname = function () {
        console.log("My swamiji's name is" + this.firstname + "" + this.lastname + "" + this.age); //this pointer firstname na field ne point kare chai
    };
    Swamiji.prototype.getLastname = function () {
    };
    return Swamiji;
}());
var hari = new Swamiji("dipalk", "ppppatel", 30); //jo only 2 para j pass karvana hoi to age ?: String chai constructor ma tya ? mukvano
//  let hari2  = new Swamiji("dipal1","patel1",1);
hari.getFirstname();
//  hari2.getFirstname();            //method call kari chai.
